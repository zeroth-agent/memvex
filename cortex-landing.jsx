...
function ModuleCard({ icon, name, tagline, description, commands, color, delay }) {
    ...
    >
      ...
      >
        {yaml.split("\n").map((line, i) => {
          ...
          const isValue = line.includes(":") && line.split(":")[1]?.trim().length > 0;
    ...
    >
      ...
      >
        <div style={{ color: "#2a2e38", fontSize: "13px", fontFamily: "'JetBrains Mono', monospace" }}>
          ...
          <span style={{ color: "#4ecdc4" }}>techtraverse.com</span>
        </div>
